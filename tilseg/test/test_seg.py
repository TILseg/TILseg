...
import tilseg
from .. import seg, cluster_processing
from seg import kmean_to_spatial_model_superpatch_wrapper 

TEST_PATCH_PATH = os.path.join(os.path.dirname(__file__), 'test',
                               'test_patches', 'patches',
                               'test_small_patch.tif')
FAIL_TEST_PATCH_PATH = os.path.join(os.path.dirname(__file__), 'test',
                                    'test_patches', 'test_img.txt')
TEST_IN_DIR_PATH = os.path.join(os.path.dirname(__file__), 'test',
                                'test_patches', 'patches')
SUPERPATCH_PATH = os.path.join(os.path.dirname(__file__), 'test',
...
class TestSeg(unittest.TestCase):
    ...
    def test_segment_TILs(self):
        ...
        tcd = seg.segment_TILs(in_dir_path=TEST_IN_DIR_PATH,
                                      model=model_super)
