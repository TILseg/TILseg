...
class TestRefineKMeans(unittest.TestCase):
    ...
    def test_kmean_to_spatial_model_superpatch_wrapper(self):
        ...
        IM_labels, dbscan_fit, cluster_mask_dict = kmean_to_spatial_model_superpatch_wrapper(SUPERPATCH_PATH,
                                            TEST_IN_DIR_PATH,
                                            TEST_SPATIAL_HYPERPARAMETERS,
                                            TEST_OUT_DIR_PATH,
    ...
    def test_kmean_to_spatial_model_patch_wrapper(self):
        ...
        """
        # one-shot test with correct inputs
        IM_labels, dbscan_fit, cluster_mask_dict = kmean_to_spatial_model_patch_wrapper(TEST_PATCH_PATH,
                        TEST_SPATIAL_HYPERPARAMETERS,
